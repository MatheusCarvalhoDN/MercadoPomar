...
<body class="text-center cadastro-bg">
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom">
            <a class="navbar-brand" href="#"><img src="<?= url ?>public/img/logo-nobg.png" width="50" height="30" alt="">Mercado Pomar</a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                <a class="btn btn-outline-success bg-light" href="./pages/carrinho.html"><i
